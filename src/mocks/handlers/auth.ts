...
export const authHandlers = [
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/local`, async ({ request }) => {
    try {
  ...
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/local/register`, async ({ request }) => {
    try {
  ...
  http.post(
    `${process.env.STRAPI_INTERNAL_URL}/api/auth/send-email-confirmation`,
    async ({ request }) => {
      try {
  ...
  http.post(
    `${process.env.STRAPI_INTERNAL_URL}/api/auth/email-confirmation`,
    async ({ request }) => {
      try {
  ...
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/forgot-password`, async ({ request }) => {
    try {
  ...
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/reset-password`, async ({ request }) => {
    try {
  ...
  http.post(
    `${process.env.STRAPI_INTERNAL_URL}/api/refresh-token-rotation`,
    async ({ request }) => {
      try {
  ...
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/logout`, async ({ request }) => {
    try {
      const payload = await body<{ refresh_token?: string }>(request);
  ...
  http.post(`${process.env.STRAPI_INTERNAL_URL}/api/auth/change-password`, async ({ request }) => {
    try {
      return HttpResponse.json(
