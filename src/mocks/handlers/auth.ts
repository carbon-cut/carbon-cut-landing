...
export const authHandlers = [
  http.post(`${process.env.BACKEND_URL}/api/auth/local`, async ({ request }) => {
    try {
  ...
  http.post(`${process.env.BACKEND_URL}/api/auth/local/register`, async ({ request }) => {
    try {
  ...
  http.post(`${process.env.BACKEND_URL}/api/auth/reset-password`, async ({ request }) => {
    try {
  ...
  http.post(`${process.env.BACKEND_URL}/api/auth/change-password`, async ({ request }) => {
    try {
      return HttpResponse.json(
