  ...
  "(pages)": {
    ...
    collectivityDashboard: {
      ...
      resultPoc: {
        ...
        municipal: "Parc de véhicules municipal",
        territory: "Transport terrestre",
        port: "Navigation",
        airport: "Transport aérien national",
        chart: {
          ...
          errorTitle: "Impossible de charger le graphique des émissions par périmètre",
          scopes: {
            scope1: "Scope 1",
            scope2: "Scope 2",
            scope3: "Scope 3",
        ...
        sourceChart: {
          title: "Émissions : énergie par source",
          description: "Année {year}.",
          ariaLabel: "Diagramme circulaire des émissions d'énergie par source",
          yearSelectorAriaLabel: "Sélectionner une année",
          errorTitle: "Impossible de charger le graphique des émissions d'énergie par source",
          sources: {
            transport: "Transport",
        ...
        ghgDevelopmentChart: {
          ...
          errorTitle: "Impossible de charger le graphique des émissions de GES",
          series: {
            energy: "Énergie",
            afatEmissions: "AFAT (émissions)",
            waste: "Déchets",
            absorptions: "Absorptions",
            totalGrossEmissions: "Total des émissions brutes",
          },
        },
        municipalAssetsChart: {
          ...
          errorTitle: "Impossible de charger le graphique des patrimoines municipaux",
          series: {
        ...
        territorialEnergyChart: {
          ...
          errorTitle: "Impossible de charger le graphique d'énergie territoriale",
          energySources: {
          ...
          transportAriaLabel: "Graphique des émissions de transport par propriétaire",
          transportErrorTitle: "Impossible de charger le graphique des émissions de transport",
          afatTab: "AFAT",
          afatAriaLabel: "Graphique AFAT par élevage, cultures et absorptions arborées",
          afatErrorTitle: "Impossible de charger le graphique AFAT",
          afatSeries: {
            livestock: "Élevage",
            crops: "Cultures",
            urbanTrees: "Arbres urbains",
          },
          municipalTab: "Patrimoine municipal",
          municipalAriaLabel: "Graphique des émissions du patrimoine municipal par énergie",
          municipalErrorTitle: "Impossible de charger le graphique du patrimoine municipal",
        },
        summaryCards: {
          ...
          errorTitle: "Impossible de charger l'indicateur",
        },
      },
      moduleStructure: {
