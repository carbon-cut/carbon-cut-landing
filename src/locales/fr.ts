      ...
      inventoryWorkspace: {
        ...
        sections: {
          ...
          entry: {
            ...
            territoryVehicles: {
              title: "Vehicules du territoire",
              description:
                "Ajouter les combinaisons type de vehicule / carburant actives sur le territoire.",
              ...
              measures: {
                vehicles: "Nb. vehicules",
                avgConsumption: "Conso moy.",
                avgMileage: "Kilometrage moy. / an",
              },
              vehicleTypes: {
                motorcycles: "Motocycles",
                publicTransportVehicles: "Vehicules transport public",
                mopeds: "Cyclomoteurs",
                agriculturalEquipment: "Materiel agricole",
                privateVehicles: "Vehicules prives",
                specializedMachinery: "Engins specialises",
                touristBuses: "Bus touristiques",
                heavyTrucks: "Poids lourds",
                lightTrucks: "Camions legers / utilitaires",
                agriculturalTractors: "Tracteurs agricoles",
                tricycles: "Tricycles",
                quadricycles: "Quadricycles",
                semiTrailerTractors: "Tracteurs routiers",
                microbuses: "Microbus",
                doubleDeckerCoaches: "Autocars a double etage",
                emergencyInterventionVehicles: "Vehicules d'intervention urgente",
                taxis: "Taxis",
                sharedTaxis: "Taxis collectifs",
                touristTaxis: "Taxis touristiques",
                motorbikes: "Motos",
                specialVehicles: "Vehicules speciaux",
            ...
            fertilizers: {
              ...
              addLabel: "Ajouter un intrant",
              rows: {
                ammonitrate: "Ammonitrate",
                dap: "DAP",
                compost: "Compost",
                sewageSludge: "Boues d'epuration",
              },
            },
        ...
        datasets: [
          ...
          },
          {
            ...
            status: "Sous dev",
            description:
              "Stock de plantations / arbres perennes avec type selectionnable et nom libre.",
            sourceMode: "TODO source-native vs year-native.",
            yearMode: "TODO temporalite et groupes de plantations.",
            implementationNote: "Placeholder AFAT volontaire.",
            sources: ["under dev perennial plantation source", "draft plantation note"],
