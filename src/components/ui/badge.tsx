...
const badgeVariantsClasses = {
  default:
    "border-transparent text-primary [background-image:linear-gradient(#D3D3D3_0_0),linear-gradient(99.94deg,#A09F9F_42.55%,rgba(0,0,0,0)_92.4%)] [background-clip:padding-box,border-box] [background-origin:border-box]",
