                        ...
                        >
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              >
                                {gasType.icon ?  gasType.icon : gasType.url2 ? (
                                  <div className='grid grid-cols-2'>
                                    <img src={gasType.url} alt={gasType.name} className={gasType.className ? gasType.className : "w-6 h-6"} />
                                    <img src={gasType.url2} alt={gasType.name} className="w-6 h-6" />
                                  </div>
                                ) : <img src={gasType.url} alt={gasType.name} className={gasType.className ? gasType.className : "w-6 h-6"} />}
                              </div>
