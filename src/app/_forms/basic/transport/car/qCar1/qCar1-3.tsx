...
const QuestionCompo3: React.FC<QuestionProps & Props> = ({
  ...
  prev
    ...
    const [ secondThermal, setSecondThermal ] = useState(mainForm.getValues(`transport.cars.${index}.secondThermal`)); 



    const t = useScopedI18n("forms.basic.transport.qCar1-3");
  return (
    <div><Question>{t("q")}</Question>
            ...
            <Input
              ...
              label={"Autre"}
              disabled={
                (secondThermal !== "other") ? true : false
              }
            />
          </Content>
    </div>
