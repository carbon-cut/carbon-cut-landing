...
import QAir from "./qAir";
import { shellLayout } from "@/app/form/_components/shellLayout";
import { Card, CardContent } from "@/components/ui/card";

const meta = {
  title: "Forms/Transport/CommonTransport/AirTravel/QAir",
  component: QAir,
  parameters: {
    layout: "fullscreen",
  },
...
export const Default: Story = {
  // @ts-ignore
  render: (args, context) => <QAir {...args} mainForm={context.mainForm} />,
};
