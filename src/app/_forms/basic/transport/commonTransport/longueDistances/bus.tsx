...
const Bus = ({ mainForm }: QuestionProps) => {
  const data =
    mainForm.getValues("transport.commonTransport.longueDistances.bus") ?? [];
          ...
          <TableRow key={index}>
            ...
            <TableCell>
              <Input
                ...
                type="number"
                form={mainForm}
                name={`transport.commonTransport.longueDistances.bus.${index}.distance`}
              />
            </TableCell>
            <TableCell>
              <Input
                ...
                type="number"
                form={mainForm}
                name={`transport.commonTransport.longueDistances.bus.${index}.nbPeople`}
              />
            </TableCell>
            <TableCell>
              <Input
                ...
                type="number"
                form={mainForm}
                name={`transport.commonTransport.longueDistances.bus.${index}.frequency`}
              />
            </TableCell>
          </TableRow>
        ))}
