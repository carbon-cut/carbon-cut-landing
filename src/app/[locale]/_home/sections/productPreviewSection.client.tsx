...
type ProductPreviewContent = {
  badge: string;
  title: string;
  description: string;
  imageAlt: string;
  items: Record<(typeof stepKeys)[number], { step: string; title: string; description: string }>;
};

export default function ProductPreviewSectionClient({
  content,
}: {
  ...
  return (
    ...
    >
      ...
      <div className="content-width flex flex-col items-center">
        ...
        >
          <h2 id="what-it-does-heading">{content.title}</h2>
        </Typography>
        <Typography
          asChild
          variant="description"
                    ...
                    <div className="max-w-xl">
                      ...
                      >
                        <div className="overflow-hidden">
                          ...
                          >
                            <p>{content.items[key].description}</p>
                          </Typography>
                        </div>
                      </div>
                    </div>
