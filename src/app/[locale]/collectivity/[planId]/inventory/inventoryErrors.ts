const datasetErrorPaths: Partial<Record<string, readonly string[]>> = {
  ...
  solarWaterHeating: ["energy", "solarWaterHeating"],
  port: ["transport", "port"],
  buses: ["transport", "buses"],
  urbanRail: ["transport", "urbanRail"],
  ...
  wastewaterTreatment: ["wastewaterSanitation"],
  wastewaterNitrogen: ["wastewaterSanitation"],
  wastewaterSludge: ["wastewaterSanitation"],
};
