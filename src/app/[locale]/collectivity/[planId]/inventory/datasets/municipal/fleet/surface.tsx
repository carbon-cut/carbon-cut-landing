...
import CollectivityMetadataScopeControl from "@/app/[locale]/collectivity/_components/metadata/CollectivityMetadataScopeControl";
...
export default function FleetSurface() {
