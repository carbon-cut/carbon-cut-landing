...
import QuestionPromptStack from "@/app/[locale]/household/form/_forms/components/QuestionPromptStack";
...
const QCar2 = (index: number) => {
  ...
  CarComponent["Symbol"] = {
    question: ["forms.basic.transport.qCar2.title", { index: index + 1 }],
    fields: [
