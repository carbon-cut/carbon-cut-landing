...
export default function CollectivitySidebar({
  ...
  return (
    ...
    >
      <SidebarHeader className="gap-4 border-b border-sidebar-border pb-0  transition-[padding] duration-200 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:px-2.5">
      ...
      <SidebarSeparator className="group-data-[collapsible=icon]:mx-3" />

      <SidebarFooter className="px-5 py-4 transition-[padding] duration-200 group-data-[collapsible=icon]:px-2.5">
        {/* <div className="space-y-2 group-data-[collapsible=icon]:hidden">
          <Typography asChild variant="eyebrow" size="xxs" className="text-sidebar-foreground/48">
            <p>{t("planSidebar.title") as string}</p>
          </Typography>
          <Typography asChild variant="caption" size="sm" className="text-sidebar-foreground/74">
